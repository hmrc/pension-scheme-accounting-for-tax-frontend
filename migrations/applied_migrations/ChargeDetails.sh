...
echo "GET        /:srn/new-return/chargeDetails                  controllers.chargeG.ChargeDetailsController.onPageLoad(mode: Mode = NormalMode, srn: SchemeReferenceNumber)" >> ../conf/app.routes
echo "POST       /:srn/new-return/chargeDetails                  controllers.chargeG.ChargeDetailsController.onSubmit(mode: Mode = NormalMode, srn: SchemeReferenceNumber)" >> ../conf/app.routes

echo "GET        /:srn/new-return/changeChargeDetails                        controllers.chargeG.ChargeDetailsController.onPageLoad(mode: Mode = CheckMode, srn: SchemeReferenceNumber)" >> ../conf/app.routes
echo "POST       /:srn/new-return/changeChargeDetails                        controllers.chargeG.ChargeDetailsController.onSubmit(mode: Mode = CheckMode, srn: SchemeReferenceNumber)" >> ../conf/app.routes
...
awk '/class CheckYourAnswersHelper/ {\
     print;\
     print "";\
     print "  def chargeDetails: Option[Row] = addRequiredDetailsToUserAnswers.get(ChargeDetailsPage) map {";\
     print "    answer =>";\
     print "      Row(";\
