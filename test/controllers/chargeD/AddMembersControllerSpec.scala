...
class AddMembersControllerSpec extends ControllerSpecBase with NunjucksSupport with JsonMatchers {
  ...
  private val jsonToPassToTemplate: Form[Boolean] => JsObject = form =>
    Json.obj(
      "form" -> form,
      "viewModel" -> GenericViewModel(submitUrl = controllers.chargeD.routes.AddMembersController.onSubmit(srn, QUARTER_START_DATE).url,
  ...
  private def table: JsObject = Json.obj(
    ...
    "rows" -> Json.arr(
      Json.arr(
        ...
        Json.obj(
          "html" -> s"<a id=member-0-view href=/manage-pension-scheme-accounting-for-tax/aa/new-return/$QUARTER_START_DATE/lifetime-allowance-charge/1/check-your-answers> View<span class= govuk-visually-hidden>first last’s lifetime allowance charge</span> </a>",
          "classes" -> cssQuarterWidth
        ),
        Json.obj(
          "html" -> s"<a id=member-0-remove href=/manage-pension-scheme-accounting-for-tax/aa/new-return/$QUARTER_START_DATE/lifetime-allowance-charge/1/remove-charge> Remove<span class= govuk-visually-hidden>first last’s lifetime allowance charge</span> </a>",
          "classes" -> cssQuarterWidth
        )
      ),
      Json.arr(
        ...
        Json.obj("text" -> formatCurrencyAmountAsString(BigDecimal(83.44)), "classes" -> cssQuarterWidth),
        Json.obj(
          "html" -> s"<a id=member-1-view href=/manage-pension-scheme-accounting-for-tax/aa/new-return/$QUARTER_START_DATE/lifetime-allowance-charge/2/check-your-answers> View<span class= govuk-visually-hidden>Joe Bloggs’s lifetime allowance charge</span> </a>",
          "classes" -> cssQuarterWidth
        ),
        Json.obj(
          "html" -> s"<a id=member-1-remove href=/manage-pension-scheme-accounting-for-tax/aa/new-return/$QUARTER_START_DATE/lifetime-allowance-charge/2/remove-charge> Remove<span class= govuk-visually-hidden>Joe Bloggs’s lifetime allowance charge</span> </a>",
          "classes" -> cssQuarterWidth
        )
      ),
      Json.arr(
  ...
  private def ua: UserAnswers =
    userAnswersWithSchemeNamePstrQuarter
      ...
      .toOption
      .get
      .set(ChargeDetailsPage(1), chargeDDetails)
      .toOption
      .get
