...
class ChargeDetailsControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  lazy val chargeDetailsRoute = routes.ChargeDetailsController.onPageLoad(NormalMode).url
  ...
  "ChargeDetails Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ChargeDetailsPage, validAnswer).success.value
