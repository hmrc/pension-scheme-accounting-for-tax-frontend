...
import pages.chargeD.{MemberDetailsPage => ChargeDMemberDetailsPage, ChargeDetailsPage => ChargeDDetailsPage}
      ...
      Row(
        ...
        actions = List(
          Action(
            ...
            href               = controllers.routes.SponsoringIndividualDetailsController.onPageLoad(CheckMode, srn).url,
