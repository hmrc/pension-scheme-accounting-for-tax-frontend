...
import models.{Quarters, GenericViewModel, AccessType, Mode, ChargeType}
          ...
          .fold(
            ...
            value => {
              for {
                ...
                _ <- userAnswersCacheConnector.saveCharge(request.internalId, updatedAnswers.data, ChargeType.ChargeTypeDeRegistration)
