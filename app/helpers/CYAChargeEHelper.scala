...
import models.{AccessType, CheckMode, SchemeReferenceNumber, YearRange}
...
class CYAChargeEHelper(srn: SchemeReferenceNumber, startDate: LocalDate, accessType: AccessType, version: Int)(implicit messages: Messages)
