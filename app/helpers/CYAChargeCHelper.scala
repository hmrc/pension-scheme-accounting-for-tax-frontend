...
import models.{AccessType, CheckMode, SchemeReferenceNumber, SponsoringEmployerType}
...
class CYAChargeCHelper(srn: SchemeReferenceNumber, startDate: LocalDate, accessType: AccessType, version: Int)(implicit messages: Messages) extends CYAHelper {
