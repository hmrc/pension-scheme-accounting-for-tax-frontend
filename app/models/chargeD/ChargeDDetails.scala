...
object ChargeDDetails {
  ...
  def unapply(details: ChargeDDetails): Option[(LocalDate, Option[BigDecimal], Option[BigDecimal])] =
    Some((details.dateOfEvent, details.taxAt25Percent, details.taxAt55Percent))
}
